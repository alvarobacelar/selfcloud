...
class CloudsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cloud" do
    assert_difference('Cloud.count') do
      post clouds_url, params: { cloud: { api_key: @cloud.api_key, cloud_type: @cloud.cloud_type, description: @cloud.description, name: @cloud.name } }
    end
  ...
  test "should update cloud" do
    patch cloud_url(@cloud), params: { cloud: { api_key: @cloud.api_key, cloud_type: @cloud.cloud_type, description: @cloud.description, name: @cloud.name } }
